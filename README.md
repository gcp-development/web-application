...
Our web application is composed of a Rest API connected to a postgres database which forms a Microservice and a [React](https://reactjs.org/docs/getting-started.html) user interface served by the Rest API.
